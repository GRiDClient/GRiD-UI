...
public class VertexBufferObject {
	...
	public void createBuffer() {
		buffer = BufferUtils.createByteBuffer(vertexSize);
		markDirty();
	}
	...
	public void addColor(MayaColor color) {
	...
	public void setColor(int index, MayaColor color) {
	...
	public void draw(int start, int vertexNumber) {
		if(vboId == 0) {
			MayaException.throwNonClosing(new VBOInvalidException("VBO ID is 0!"));
			return;
		}
